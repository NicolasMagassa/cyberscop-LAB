...
- [x] **Création de la Meta Description SEO :** Ajout du champ `metaDescription` sur Strapi pour toutes les collections d'articles, et mise à jour dynamique du titre (`<title>`) et de la meta description dans le `<head>` pour l'optimisation SEO (voir le guide dans [technicalBackend.md](./docs/technicalBackend.md#-optimisation-seo--ajout-de-la-meta-description)).
